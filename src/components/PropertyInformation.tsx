  ...
  return <div className="space-y-6">
      ...
      <div className="space-y-6">
        <div className="space-y-4 bg-inherit">
          ...
          {data.status === "vacant" && <div className="flex items-center space-x-2">
              <Switch id="winterized" checked={data.isWinterized} onCheckedChange={checked => onChange("isWinterized", checked)} />
              <Label htmlFor="winterized" className="text-white">Property is winterized</Label>
            </div>}

          {canUpdateMls && <div className="flex items-center space-x-2">
              <Switch id="updateMls" checked={data.updateMls} onCheckedChange={checked => onChange("updateMls", checked)} />
